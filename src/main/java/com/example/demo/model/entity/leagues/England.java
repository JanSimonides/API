...
public class England {
    ...
    public int score (){
        ...
        String[] result  = {"null","Manchester City", "Manchester United", "Chelsea", "Arsenal", "Liverpool", "Spurs", "West Ham", "Newcastle", "Wolverhampton", "Watford",
                "Leicester", "Brighton", "Norwich", "Everton", "Sheffield", "Crystal Palace", "Burnley", "Aston Villa", "Southampton", "Bournemouth"};
